...
public class CryptoOpsTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println("CRYPTOGRAPHIC APPROVED OPERATIONS VALIDATION SUITE");
        System.out.println("--------------------------------------------------------------------------------");
        ...
        try {
            ...
            logFailure(
                    1,
                    "Approved-Only Mode Verification",
                    "Unable to determine FIPS operational mode due to provider or configuration error.",
                    t);
        }

        // ===== TEST 02: AES Encryption =====
        try {
        ...
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println(
                "[SUCCESS] OVERALL CRYPTOGRAPHIC APPROVED OPERATIONS STATUS: PASSED (All approved cryptographic primitives executed successfully under enforced policy.)");
        System.out.println("--------------------------------------------------------------------------------");
    }
}
